"""Run the Chengdu paper-style TR/CR/BPT versus service-radius experiment."""
...
def main() -> int:
    """Parse CLI args and launch the service-radius paper experiment."""
    parser = build_script_parser("Run Chengdu paper experiment 3: metrics versus service radius.")
    ...
    if args.execution_mode == "direct":
        ...
        run_chengdu_paper_split_experiment(
            ...
            tmp_root=Path(args.tmp_root or "/tmp/chengdu_exp3_split"),
            output_dir=Path(args.output_dir),
            algorithms=args.algorithms,
            fixed_config_overrides=fixed_config,
            preset_name=args.preset,
        ...
        raise SystemExit(f"Unsupported execution mode for Exp-3: {args.execution_mode}")
    return 0
