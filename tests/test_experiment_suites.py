...
class ExperimentSuiteTests(unittest.TestCase):
    ...
    def test_paper_config_exposes_supported_chengdu_axes_and_algorithms(self) -> None:
        """The Chengdu paper config should expose the supported axes and default baseline list."""
        ...
        self.assertEqual(
            ...
            ("capa", "greedy", "ramcom", "mra", "basegta", "impgta"),
        )
        self.assertIn("chengdu-paper", PAPER_SUITE_PRESETS)
        self.assertEqual(
            tuple(PAPER_SUITE_PRESETS["chengdu-paper"]["formal"].keys()),
            ("num_parcels", "local_couriers", "service_radius", "platforms", "courier_capacity"),
        )
    ...
    def test_suite_runs_multiple_predefined_comparisons(self) -> None:
        ...
        self.assertEqual(summary["suite"], "chengdu-paper")
        self.assertEqual(summary["preset"], "formal")
        self.assertEqual(
            compare_calls,
            [
