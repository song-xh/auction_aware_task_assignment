...
class MetricAlignmentTest(unittest.TestCase):
    ...
    def test_basegta_cross_tr_includes_partner_platform_sharing_payment(self) -> None:
        """BaseGTA cross revenue should deduct partner payment using CAPA's `fare - payment` semantics."""
