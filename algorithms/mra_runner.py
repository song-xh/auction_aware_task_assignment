"""Unified MRA strategy wrapper for the algorithm registry."""
...
class MRAAlgorithmRunner(AlgorithmRunner):
    """Run the Chengdu-adapted MRA baseline through the unified environment interface."""
    ...
    def run(
        ...
        """Execute MRA against a prepared Chengdu environment and return a summary."""
